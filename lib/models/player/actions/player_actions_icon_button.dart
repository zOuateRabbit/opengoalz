...
class PlayerActionsIconButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool hasActions = index != null ||
        player.isPartOfClubOfCurrentUser ||
        player.isEmbodiedByCurrentUser ||
        (player.idClub == null &&
            player.userName == null &&
            player.dateDeath == null);

    return IconButton(
      icon: Icon(Icons.pending_actions_outlined,
          size: iconSizeMedium, color: hasActions ? Colors.green : Colors.grey),
      tooltip: hasActions ? 'Player actions' : 'No actions available',
                        ...
                        ListTile(
                          ...
                          onTap: () async {
                            ...
                            await operationInDB(context, 'FUNCTION',
                                'players_handle_embodied_player',
                                data: {
                          ...
                          subtitle: Text(
                              'Stop embodying ${player.getFullName()}',
                              style: styleItalicBlueGrey.copyWith(
                                  fontSize: fontSizeSmall)),
                          shape: shapePersoRoundedBorder(),
                        ),
                        ...
                        ListTile(
                          ...
                          onTap: () async {
                              ...
                              builder: (BuildContext context) {
                                return AlertDialog(
                                  title: Text(
                                      ...
                                      style:
                                          TextStyle(fontSize: fontSizeLarge)),
                                  content: Text(
                            ...
                            await operationInDB(context, 'FUNCTION',
                                ...
                                messageSuccess: 'You are now embodying ' +
                                    player.getFullName());
                          },
                          subtitle: Text(
                              'Start embodying ${player.getFullName()}',
                              style: styleItalicBlueGrey.copyWith(
                                  fontSize: fontSizeSmall)),
                          shape: shapePersoRoundedBorder(),
                        ),
